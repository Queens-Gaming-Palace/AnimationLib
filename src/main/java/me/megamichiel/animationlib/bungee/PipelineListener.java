...
public class PipelineListener<E extends Event> implements Listener, PipelineContext {
    ...
    
    {
        ...
        try {
            ...
            EventBus bus = (EventBus) field.get(ProxyServer.getInstance().getPluginManager());
            ...
            mmap = (Multimap<Plugin, Listener>) field.get(ProxyServer.getInstance().getPluginManager());
        } catch (Exception ex) {
            lock = null;
            map = null;
            method = null;
